...
final class $$TeachersTableReferences
  ...
  _syllabusesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.syllabuses,
    aliasName: $_aliasNameGenerator(db.teachers.id, db.syllabuses.teacher),
  );
...
final class $$SyllabusesTableReferences
  ...
  static $TeachersTable _teacherTable(_$AppDatabase db) => db.teachers
      .createAlias($_aliasNameGenerator(db.syllabuses.teacher, db.teachers.id));
