...
class _CourseWidgetRenderHostState
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        widget.child,
        if (_renderInput case final input?)
          Transform.translate(
            offset: const Offset(-251, 0),
            child: IgnorePointer(
                  ...
                  child: Theme(
                    ...
                    child: RepaintBoundary(
                      ...
                      child: SizedBox.fromSize(
                        size: CourseTableExport.logicalSize,
...
/// Fixed, full-week timetable surface rendered into the Android widget bitmap.
class CourseTableExport extends StatelessWidget {
  ...
  static const logicalSize = Size(250, 400);
  ...
  static const _gridHeight = 372.0;
  ...
  Widget build(BuildContext context) {
    ...
    final rowHeight = _gridHeight / periods.length;
    final dayWidth =
        (logicalSize.width - _outerPadding * 2 - _periodStubWidth) /
        days.length;
