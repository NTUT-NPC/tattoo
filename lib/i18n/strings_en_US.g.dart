...
// Path: ntutWifi
class _Translations$ntutWifi$en_US extends Translations$ntutWifi$zh_TW {
	_Translations$ntutWifi$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
	...
	@override late final _Translations$ntutWifi$fieldValues$en_US fieldValues = _Translations$ntutWifi$fieldValues$en_US._(_root);
	@override late final _Translations$ntutWifi$fallbackSteps$en_US fallbackSteps = _Translations$ntutWifi$fallbackSteps$en_US._(_root);
	@override late final _Translations$ntutWifi$provisioning$en_US provisioning = _Translations$ntutWifi$provisioning$en_US._(_root);
	@override late final _Translations$ntutWifi$compatPrompt$en_US compatPrompt = _Translations$ntutWifi$compatPrompt$en_US._(_root);
}
...
class _Translations$ntutWifi$actions$en_US extends Translations$ntutWifi$actions$zh_TW {
	_Translations$ntutWifi$actions$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _Translations$ntutWifi$fields$en_US extends Translations$ntutWifi$fields$zh_TW {
	_Translations$ntutWifi$fields$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _Translations$ntutWifi$fieldValues$en_US extends Translations$ntutWifi$fieldValues$zh_TW {
	_Translations$ntutWifi$fieldValues$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _Translations$ntutWifi$fallbackSteps$en_US extends Translations$ntutWifi$fallbackSteps$zh_TW {
	_Translations$ntutWifi$fallbackSteps$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _Translations$ntutWifi$provisioning$en_US extends Translations$ntutWifi$provisioning$zh_TW {
	_Translations$ntutWifi$provisioning$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _Translations$ntutWifi$compatPrompt$en_US extends Translations$ntutWifi$compatPrompt$zh_TW {
	_Translations$ntutWifi$compatPrompt$en_US._(TranslationsEnUs root) : this._root = root, super.internal(root);
