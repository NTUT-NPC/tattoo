...
- **Capture presets:** when adding or changing a Service-layer HTML/XML request or parser, check related integration tests and update `tool/html_snapshot_presets.dart` presets if the request is not already covered.
